...
**hifi-wifi v3.0** is a complete rewrite of the project in Rust, designed to be a set-and-forget network optimizer for Linux handhelds (Steam Deck, Bazzite, Arch). It runs as a background systemd service (~12MB RAM, <1% CPU) to dynamically manage traffic shaping, power settings, and latency.
